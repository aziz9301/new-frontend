                                ...
                                <div className="p-1">
                                    ...
                                    <div className="relative  p-3 border-t">
                                        ...
                                        <div className="mt-1.5 flex items-center justify-between text-text">
                                            ...
                                            <button onClick={() => handleAddProduct(product._id)} type="button" className="flex items-center divide-x rounded-lg border border-primary bg-white text-center text-md font-medium text-secondary-700 shadow-sm hover:bg-gray-100">
