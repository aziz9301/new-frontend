            ...
            <header className="bg-white sticky top-0 z-40 w-full px-2 md:px-4">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <nav className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
                        ...
                        <div className="px-6 mt-6">
                            <button className="text-md font-medium text-text hidden md:flex" onClick={() => signIn('google')}>
                                Login
                            </button>
                            <button className="text-md font-medium text-text hidden max-md:flex md:hidden" onClick={() => signIn('google')}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            </button>
