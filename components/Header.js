...
export default function Settings() {
    ...
    return (
        <>
            <header className="bg-white sticky top-0 z-40 w-full px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <nav className="flex items-center justify-between h-16 lg:h-20">
                        <div className="flex items-center space-x-4 lg:space-x-10">
                            <Link
                                className="flex items-center text-lg font-medium text-text hover:text-primary"
                                href="/"
                            >
                                <svg
                            ...
                            <div className="hidden lg:flex space-x-4">
                                <Link
                                    className={`${pathname === "/" ? "text-primary" : "text-accent"
                                        } hover:text-accent/75 transition`}
                                    href="/"
                                >
                                    Home
                                </Link>
                                ...
                                <Link
                                    className={`${pathname === "/products" ? "text-primary" : "text-accent"
                                        } hover:text-accent/75 transition`}
                                    href="/products"
                                >
                                    All Product
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            {session ? (
                                <div className="hidden lg:flex items-center space-x-2">
                                    <div
                                        className="cursor-pointer text-text font-medium"
                            ...
                            <Link
                                className="group rounded-md font-medium text-md flex items-center transition p-2"
                                href="/cart"
                            >
                                <svg
                                    fill="none"
            ...
            {/* Mobile Sidebar */}
            <div
                className={`fixed inset-0 bg-black bg-opacity-50 z-50 transition-transform transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                    } lg:hidden`}
                onClick={toggleSidebar}
            >
                <div
                ...
                >
                    ...
                    <Link
                        className={`block ${pathname === "/" ? "text-primary" : "text-accent"
                            } hover:text-accent/75 transition mb-2`}
                        href="/"
                    >
                        Home
                    </Link>
                    ...
                    <Link
                        className={`block ${pathname === "/products" ? "text-primary" : "text-accent"
                            } hover:text-accent/75 transition mb-2`}
                        href="/products"
                    >
                        All Product
                    ...
                    {session ? (
                        <>
                            <div
                                className="cursor-pointer text-text font-medium mb-2"
                                onClick={() => router.push("/profile")}
                            >
                                {session.user.name || session.user.email}
                            </div>
                            <button
                                className="text-md font-medium text-text mb-2"
                                onClick={() => signOut()}
                            >
                                Logout
                            </button>
